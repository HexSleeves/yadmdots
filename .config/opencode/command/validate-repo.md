...
1. List all files in `/Users/jacob.lecoq.ext/.config/opencode/context/`
...
1. **Orphaned Context File**
   - File: `/Users/jacob.lecoq.ext/.config/opencode/context/legacy/old-patterns.md`
...
1. **Missing Context File**
   ...
   - Expected path: `/Users/jacob.lecoq.ext/.config/opencode/context/core/advanced-patterns.md`
...
1. Create missing file: `/Users/jacob.lecoq.ext/.config/opencode/context/core/advanced-patterns.md`
