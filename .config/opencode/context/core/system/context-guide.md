...
**Index Location**: `/Users/jacob.lecoq.ext/.config/opencode/context/index.md` - Quick map of all contexts
...
**Central Index**: `/Users/jacob.lecoq.ext/.config/opencode/context/index.md` - Ultra-compact map of all contexts
...
All files are in `/Users/jacob.lecoq.ext/.config/opencode/context/core/` with organized subfolders:
...
- Load `/Users/jacob.lecoq.ext/.config/opencode/context/index.md`
...
### /Users/jacob.lecoq.ext/.config/opencode/context/core/standards/code.md
- Writing new code
- Modifying existing code
- Following modular/functional patterns
- Making architectural decisions

### /Users/jacob.lecoq.ext/.config/opencode/context/core/standards/docs.md
- Writing README files
- Creating API documentation
- Adding code comments

### /Users/jacob.lecoq.ext/.config/opencode/context/core/standards/tests.md
- Writing new tests
- Running test suites
- Debugging test failures

### /Users/jacob.lecoq.ext/.config/opencode/context/core/standards/patterns.md
- Error handling
- Security patterns
- Common code patterns

### /Users/jacob.lecoq.ext/.config/opencode/context/core/standards/analysis.md
- Analyzing codebase patterns
- Investigating bugs
- Evaluating architecture

### /Users/jacob.lecoq.ext/.config/opencode/context/core/workflows/delegation.md
- Delegating to general agent
- Creating task context
- Multi-file coordination

### /Users/jacob.lecoq.ext/.config/opencode/context/core/workflows/task-breakdown.md
- Tasks with 4+ files
- Estimated effort >60 minutes
- Complex dependencies

### /Users/jacob.lecoq.ext/.config/opencode/context/core/workflows/sessions.md
- Session lifecycle
- Cleanup procedures
- Session isolation

### /Users/jacob.lecoq.ext/.config/opencode/context/core/workflows/review.md
- Reviewing code
