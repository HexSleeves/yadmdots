...
cp -r /Users/jacob.lecoq.ext/.config/opencode/context ~/.opencode/
```
...
**Context-aware:** Agents automatically load patterns from `/Users/jacob.lecoq.ext/.config/opencode/context/` to follow your coding standards.
...
nano ~//Users/jacob.lecoq.ext/.config/opencode/context/project/project-context.md
...
A: Edit `~//Users/jacob.lecoq.ext/.config/opencode/context/project/project-context.md` - agents automatically load this file.
